...
const About = () => {
  return (
    <div className="bg-soft text-navy overflow-hidden">
      ...
      <section className="pt-36 sm:pt-44 pb-14 md:pb-20 bg-soft border-b border-navy/10">
        <div className="container-px">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4">
            <div className="p-5 rounded-2xl bg-white border border-navy/10 shadow-xs">
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="flex items-center gap-2.5">
                ...
                <span className="eyebrow text-teal">01 — Who We Are</span>
              </div>

              <h2 className="font-display text-3xl sm:text-4xl md:text-5xl text-navy leading-tight">
                Built to be <span className="italic text-teal">Active</span> and driven to <span className="italic text-teal">Achieve</span>.
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className="p-4 rounded-2xl bg-white border border-navy/10 shadow-xs flex items-center gap-3">
            ...
            <div className="lg:col-span-6 relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-navy/10">
                <img
      ...
      {/* ========================================================================= */}
      <section className="py-24 md:py-36 bg-midnight text-ivory relative overflow-hidden">
        ...
        <div className="container-px relative z-10">
          {/* Section Header */}
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 pb-8 border-b border-ivory/15 gap-6">
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-3">
                <Award size={16} className="text-sand" />
                <span className="eyebrow text-sand">02 — Why Choose Acciva?</span>
              </div>
              <h2 className="font-display text-3xl sm:text-5xl md:text-6xl tracking-tight leading-tight">
                Experienced, Knowledgeable, <br />
                <span className="italic text-sand font-normal">Confident & Courteous.</span>
              </h2>
            </div>
            <p className="text-ivory/70 text-base max-w-md font-light leading-relaxed">
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <h3 className="font-display text-xl sm:text-2xl text-ivory font-bold mb-3 group-hover:text-sand transition-colors">
                      {f.title}
                    </h3>

                    <p className="text-sm text-ivory/70 leading-relaxed font-light mb-6">
                      {f.desc}
                    </p>
                  </div>
                  ...
                  <div className="pt-4 border-t border-ivory/10 flex items-center justify-between">
                    ...
                    <NavLink
                      to="/contact"
                      className="inline-flex items-center gap-1.5 text-xs font-mono text-ivory/60 group-hover:text-sand transition-colors"
                    >
      ...
      <section className="py-24 md:py-36 bg-soft relative">
        <div className="container-px">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="eyebrow text-teal">03 — Purpose & Philosophy</span>
            <h2 className="font-display text-3xl sm:text-5xl md:text-6xl text-navy mt-4 leading-tight">
              Our Vision & <span className="italic text-teal">Mission.</span>
            </h2>
      ...
      <section className="py-28 md:py-40 bg-midnight text-ivory relative overflow-hidden border-t border-ivory/15">
        ...
        <div className="container-px relative z-10 text-center max-w-4xl mx-auto">
          ...
          <h2 className="font-display text-4xl sm:text-6xl md:text-7xl text-ivory leading-tight drop-shadow-md">
            Elevate Your Corporate Transit. <br />
            <span className="italic text-sand font-normal">Partner with Acciva.</span>
          </h2>
