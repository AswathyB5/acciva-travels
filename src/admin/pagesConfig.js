import { PanelTop, PanelBottom, Home, Info, Car, CarFront, Cpu, Newspaper, Mail, Briefcase, Users, Truck } from "lucide-react";
...
export const pages = [
  ...
  {
    key: "corporate-car-rental-services",
    label: "Corporate Car Rental Services",
    parent: "services",
    icon: CarFront,
    description: "The dedicated Corporate Car Rental Services in Bangalore subpage, linked from the Services nav dropdown.",
    relatedCollections: [],
    sections: [
      {
        key: "hero",
        ...
        fields: [
          { name: "heroEyebrow", label: "Eyebrow", type: "text", default: "Corporate Mobility" },
          { name: "heroTitleMain", label: "Title", type: "textarea", default: "Corporate Car Rental" },
          { name: "heroTitleAccent", label: "Title (Highlighted)", type: "text", default: "Services in Bangalore" },
          {
            name: "heroBackgroundImage",
            label: "Background Image",
            type: "image",
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: "Image",
            type: "image",
            default: "https://di-uploads-pod1.s3.amazonaws.com/depaulachevy/uploads/2015/08/rental-car-lot-1024x683.jpg",
          },
        ],
      },
      {
        key: "requirements",
        label: "3. Corporate Car Rental for Different Business Requirements",
        fields: [
          { name: "reqEyebrow", label: "Eyebrow", type: "text", default: "Business Requirements" },
          { name: "reqHeadingMain", label: "Heading", type: "text", default: "Corporate Car Rental for Different" },
          { name: "reqHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Business Requirements" },
          {
            name: "reqParagraphs",
            label: "Paragraphs",
            type: "list",
      ...
      {
        key: "city",
        label: "4. Business Travel Across Bangalore",
        fields: [
          { name: "cityEyebrow", label: "Eyebrow", type: "text", default: "Around the City" },
          { name: "cityHeadingMain", label: "Heading", type: "text", default: "Business Travel Across" },
          { name: "cityHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Bangalore" },
          {
            name: "cityParagraphs",
            label: "Paragraphs",
            type: "list",
          ...
          },
          {
            ...
            label: "Image",
            type: "image",
            default: "https://www.getgoing.com/wp-content/uploads/2026/06/woman-working-from-laptop-1.jpg",
          },
        ],
      },
      {
        key: "airport",
        label: "5. Airport Transfers for Corporate Travel",
        fields: [
          { name: "airportEyebrow", label: "Eyebrow", type: "text", default: "Airport Transfers" },
          { name: "airportHeadingMain", label: "Heading", type: "text", default: "Airport Transfers for Corporate" },
          { name: "airportHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Travel" },
          {
            name: "airportParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
          ...
          },
          {
            ...
            label: "Image",
            type: "image",
            default: "https://media.istockphoto.com/id/1195019183/photo/shuttle-bus-brought-people-to-the-airport-for-the-flight.jpg?s=612x612&w=0&k=20&c=K-62TWK0Y8w9lIWRnF3rrdggS47lHPn1DvOfLIbkBjA=",
          },
        ],
      },
      {
        key: "employee",
        label: "6. Transportation for Employees",
        fields: [
          { name: "employeeEyebrow", label: "Eyebrow", type: "text", default: "Employee Travel" },
          { name: "employeeHeadingMain", label: "Heading", type: "text", default: "Transportation for" },
          { name: "employeeHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Employees" },
          {
            name: "employeeParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
      ...
      {
        key: "meetings",
        label: "7. Cars for Meetings and Client Visits",
        fields: [
          { name: "meetingsEyebrow", label: "Eyebrow", type: "text", default: "Meetings & Client Visits" },
          { name: "meetingsHeadingMain", label: "Heading", type: "text", default: "Cars for Meetings and Client" },
          { name: "meetingsHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Visits" },
          {
            name: "meetingsParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
      ...
      {
        key: "events",
        label: "8. Corporate Events, Conferences and Business Programmes",
        fields: [
          { name: "eventsEyebrow", label: "Eyebrow", type: "text", default: "Events & Conferences" },
          { name: "eventsHeadingMain", label: "Heading", type: "text", default: "Corporate Events, Conferences and Business" },
          { name: "eventsHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Programmes" },
          {
            name: "eventsParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
      ...
      {
        key: "outstation",
        label: "9. Outstation Car Rental for Business Travel",
        fields: [
          { name: "outstationEyebrow", label: "Eyebrow", type: "text", default: "Outstation Travel" },
          { name: "outstationHeadingMain", label: "Heading", type: "text", default: "Outstation Car Rental for Business" },
          { name: "outstationHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Travel" },
          {
            name: "outstationParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
          ...
          {
            name: "outstationImage",
            label: "Image",
            type: "image",
            default: "https://images.pexels.com/photos/2464531/pexels-photo-2464531.jpeg?auto=compress&cs=tinysrgb&w=1200",
          },
        ],
      },
      {
        key: "rentals",
        label: "10. Short-Term and Long-Term Corporate Rentals",
        fields: [
          { name: "rentalsEyebrow", label: "Eyebrow", type: "text", default: "Flexible Arrangements" },
          { name: "rentalsHeadingMain", label: "Heading", type: "text", default: "Short-Term and Long-Term Corporate" },
          { name: "rentalsHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Rentals" },
          {
            name: "rentalsParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
          ...
          },
          {
            ...
            label: "Closing Paragraph",
            type: "richtext",
            default: "The right arrangement depends on how frequently the company needs transportation and how its employees or business visitors typically travel.",
          },
        ],
      },
      {
        key: "whyUse",
        label: "11. Why Businesses Use Corporate Car Rental Services",
        fields: [
          { name: "whyUseEyebrow", label: "Eyebrow", type: "text", default: "Why It Matters" },
          { name: "whyUseHeadingMain", label: "Heading", type: "text", default: "Why Businesses Use Corporate Car Rental" },
          { name: "whyUseHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Services" },
          {
            name: "whyUseParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
      ...
      {
        key: "whyAcciva",
        label: "12. Why Acciva Travels",
        fields: [
          { name: "whyAccivaEyebrow", label: "Eyebrow", type: "text", default: "Distinct Advantage" },
          { name: "whyAccivaHeadingMain", label: "Heading", type: "text", default: "Why" },
          { name: "whyAccivaHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Acciva Travels?" },
          {
            name: "whyAccivaParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
          ...
          },
          {
            ...
            label: "Image",
            type: "image",
            default: "https://media.istockphoto.com/id/182913362/photo/travel-coaches-at-tourist-destination-parked-in-a-row.jpg?s=612x612&w=0&k=20&c=WydkBjrqbYQKAITmQ9oEWzwzsQbQhp15OCOiSTgqj-g=",
          },
        ],
      },
      {
        key: "bangalore",
        label: "13. Corporate Car Rental in Bangalore",
        fields: [
          { name: "bangaloreEyebrow", label: "Eyebrow", type: "text", default: "Serving Bangalore" },
          { name: "bangaloreHeadingMain", label: "Heading", type: "text", default: "Corporate Car Rental in" },
          { name: "bangaloreHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Bangalore" },
          {
            name: "bangaloreParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
          ...
          {
            name: "bangaloreClosing",
            label: "Closing Paragraph",
            type: "richtext",
            default: "Whether you need a vehicle for an important client visit, transportation for employees, an airport pickup, a corporate event, or an outstation business trip, the requirement can be discussed with the Acciva Travels team.",
          },
        ],
      },
      {
        key: "talk",
        label: "14. Talk to Acciva Travels CTA",
        fields: [
          { name: "talkEyebrow", label: "Eyebrow", type: "text", default: "" },
          { name: "talkHeadingMain", label: "Heading", type: "text", default: "Talk to" },
          { name: "talkHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Acciva Travels" },
          {
            name: "talkParagraphs",
            label: "Paragraphs",
            type: "list",
  ...
  {
    key: "luxury-car-rental-services",
    label: "Luxury Car Rental",
    parent: "services",
    icon: Car,
    description: "The dedicated Luxury Car Rental subpage, linked from the Services nav dropdown.",
    relatedCollections: [],
    sections: [
      {
        key: "hero",
        label: "1. Hero",
        fields: [
          { name: "heroEyebrow", label: "Eyebrow", type: "text", default: "Luxury Travel" },
          { name: "heroTitleMain", label: "Title", type: "textarea", default: "Luxury Car Rental in Bangalore for" },
          { name: "heroTitleAccent", label: "Title (Highlighted)", type: "text", default: "Special Occasions and Premium Travel" },
          {
            name: "heroBackgroundImage",
            label: "Background Image",
            type: "image",
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: "Image",
            type: "image",
            default: "https://images.pexels.com/photos/19894151/pexels-photo-19894151.jpeg?auto=compress&cs=tinysrgb&w=1200",
          },
        ],
      },
      {
        key: "different",
        label: "3. What Makes a Luxury Car Rental Different?",
        fields: [
          { name: "differentEyebrow", label: "Eyebrow", type: "text", default: "The Luxury Difference" },
          { name: "differentHeadingMain", label: "Heading", type: "text", default: "What Makes a Luxury Car Rental" },
          { name: "differentHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Different?" },
          {
            name: "differentParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
      ...
      {
        key: "wedding",
        label: "4. Luxury Car Rental for Weddings",
        fields: [
          { name: "weddingEyebrow", label: "Eyebrow", type: "text", default: "Wedding Transportation" },
          { name: "weddingHeadingMain", label: "Heading", type: "text", default: "Luxury Car Rental for" },
          { name: "weddingHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Weddings" },
          {
            name: "weddingParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
          ...
          },
          {
            ...
            label: "Image",
            type: "image",
            default: "https://images.pexels.com/photos/13044866/pexels-photo-13044866.jpeg?auto=compress&cs=tinysrgb&w=1200",
          },
        ],
      },
      {
        key: "executives",
        label: "5. Luxury Cars for Corporate Executives",
        fields: [
          { name: "executivesEyebrow", label: "Eyebrow", type: "text", default: "Corporate Travel" },
          { name: "executivesHeadingMain", label: "Heading", type: "text", default: "Luxury Cars for Corporate" },
          { name: "executivesHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Executives" },
          {
            name: "executivesParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
          ...
          {
            name: "executivesImage",
            label: "Image",
            type: "image",
            default: "https://www.avis.co.in/blog/wp-content/uploads/2025/05/ANA0203-copy.jpg",
          },
        ],
      },
      {
        key: "airport",
        label: "6. Airport Transfers in Style",
        fields: [
          { name: "airportEyebrow", label: "Eyebrow", type: "text", default: "Airport Transfers" },
          { name: "airportHeadingMain", label: "Heading", type: "text", default: "Airport Transfers in" },
          { name: "airportHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Style" },
          {
            name: "airportParagraphs",
            label: "Paragraphs",
            type: "list",
      ...
      {
        key: "occasions",
        label: "7. Luxury Car Rental for Special Occasions",
        fields: [
          { name: "occasionsEyebrow", label: "Eyebrow", type: "text", default: "Celebrations" },
          { name: "occasionsHeadingMain", label: "Heading", type: "text", default: "Luxury Car Rental for Special" },
          { name: "occasionsHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Occasions" },
          {
            name: "occasionsParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
      ...
      {
        key: "events",
        label: "8. Luxury Cars for Events and Photoshoots",
        fields: [
          { name: "eventsEyebrow", label: "Eyebrow", type: "text", default: "Events & Productions" },
          { name: "eventsHeadingMain", label: "Heading", type: "text", default: "Luxury Cars for Events and" },
          { name: "eventsHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Photoshoots" },
          {
            name: "eventsParagraphs",
            label: "Paragraphs",
            type: "list",
      ...
      {
        key: "leisure",
        label: "9. Luxury Car Rental for Business and Leisure Travel",
        fields: [
          { name: "leisureEyebrow", label: "Eyebrow", type: "text", default: "Business & Leisure" },
          { name: "leisureHeadingMain", label: "Heading", type: "text", default: "Luxury Car Rental for Business and Leisure" },
          { name: "leisureHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Travel" },
          {
            name: "leisureParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
          ...
          },
          {
            ...
            label: "Image",
            type: "image",
            default: "https://images.pexels.com/photos/4964910/pexels-photo-4964910.jpeg?auto=compress&cs=tinysrgb&w=1200",
          },
        ],
      },
      {
        key: "chauffeur",
        label: "10. Chauffeur-Driven Luxury Car Rental",
        fields: [
          { name: "chauffeurEyebrow", label: "Eyebrow", type: "text", default: "Chauffeur Service" },
          { name: "chauffeurHeadingMain", label: "Heading", type: "text", default: "Chauffeur-Driven Luxury Car" },
          { name: "chauffeurHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Rental" },
          {
            name: "chauffeurParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
      ...
      {
        key: "outstation",
        label: "11. Luxury Car Rental for Outstation Travel",
        fields: [
          { name: "outstationEyebrow", label: "Eyebrow", type: "text", default: "Outstation Travel" },
          { name: "outstationHeadingMain", label: "Heading", type: "text", default: "Luxury Car Rental for Outstation" },
          { name: "outstationHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Travel" },
          {
            name: "outstationParagraphs",
            label: "Paragraphs",
          ...
          },
          {
            ...
            label: "Image",
            type: "image",
            default: "https://images.pexels.com/photos/29013472/pexels-photo-29013472.jpeg?auto=compress&cs=tinysrgb&w=1200",
          },
        ],
      },
      {
        key: "choosing",
        label: "12. Choosing the Right Luxury Car Rental",
        fields: [
          { name: "choosingEyebrow", label: "Eyebrow", type: "text", default: "Making the Choice" },
          { name: "choosingHeadingMain", label: "Heading", type: "text", default: "Choosing the Right Luxury Car" },
          { name: "choosingHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Rental" },
          {
            name: "choosingParagraphs",
            label: "Paragraphs",
            type: "list",
            richItems: true,
            default: [
          ...
          {
            name: "choosingClosing",
            label: "Closing Paragraph",
            type: "richtext",
            default: "Sharing these details with the rental provider beforehand makes it easier to identify a vehicle and rental arrangement that fits the occasion.",
          },
        ],
      },
      {
        key: "whyAcciva",
        label: "13. Why Choose Acciva Travels for Luxury Car Rental?",
        fields: [
          { name: "whyAccivaEyebrow", label: "Eyebrow", type: "text", default: "Distinct Advantage" },
          { name: "whyAccivaHeadingMain", label: "Heading", type: "text", default: "Why Choose Acciva Travels for Luxury Car" },
          { name: "whyAccivaHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Rental?" },
          {
            name: "whyAccivaParagraphs",
            label: "Paragraphs",
            type: "list",
      ...
      {
        key: "bangalore",
        label: "14. Luxury Car Rental in Bangalore",
        fields: [
          { name: "bangaloreEyebrow", label: "Eyebrow", type: "text", default: "Serving Bangalore" },
          { name: "bangaloreHeadingMain", label: "Heading", type: "text", default: "Luxury Car Rental in" },
          { name: "bangaloreHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Bangalore" },
          {
            name: "bangaloreParagraphs",
            label: "Paragraphs",
      ...
      {
        key: "talk",
        label: "15. Planning a Luxury Car Rental? CTA",
        fields: [
          { name: "talkEyebrow", label: "Eyebrow", type: "text", default: "" },
          { name: "talkHeadingMain", label: "Heading", type: "text", default: "Planning a Luxury Car" },
          { name: "talkHeadingAccent", label: "Heading (Highlighted)", type: "text", default: "Rental?" },
          {
            name: "talkParagraphs",
            label: "Paragraphs",
            type: "list",
